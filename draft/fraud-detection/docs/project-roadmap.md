...
gantt
    ...
    Viết Methodology + Results draft (Duy) :done, s3_4, 2026-09-01, 4d
...
| Viết Results draft từ prediction artifacts <br> *[Đầu vào: `reports/*_predictions.pkl` + `y_test.pkl` \| Đầu ra: Chương 5 (5.1–5.6), `run_report_metrics.py` → `reports/ch5_metrics_recomputed.csv`, Hình 5.1 và hai bảng kết quả trong DOCX/PDF Sprint 3]* | 🔴 Critical | ✅ |
...
| Task | Ưu tiên | Trạng thái |
|------|---------|-----------|
| Đối chiếu Results draft và viết Discussion (Word) <br> *[Đầu vào: `reports/model_comparison.csv` + plots \| Đầu ra: Chương 5 đã xác nhận + Chương 6 Thảo luận]* | 🔴 Critical | 🔲 |
