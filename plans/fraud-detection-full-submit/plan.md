...
| 07 | [Report & PPT](./phase-07-report-ppt.md) | Duy + Hôn | Sprint 2–4* | `pending` | Word/PDF Chương 1–7 ✅ (Duy) + Slide học thuật 21 trang ✅ (Thanh, PR #18 — bản chính thức); chỉ còn Abstract |
...
>
> **Phase 07 — Duy & Hôn — checkpoint 04/09/2026:** Duy đã hoàn thành bản nháp Sprint 3 Chương 1–5, gồm Methodology và Results draft tái tính từ prediction artifacts; source + DOCX/PDF 24 trang giữ format Sprint 2, mục lục có đủ các mục nhỏ 4.1–4.9 và 5.1–5.6, Chương 5 có Hình 5.1 và Hình 5.2, không còn dấu chấm phẩy và đã qua visual QA toàn bộ trang. Bản Word nay được sinh tự động từ `report-source.md` bằng `build_report.py`, không chỉnh tay. Chương 5 tái lập được bằng `run_report_metrics.py` → `reports/ch5_metrics_recomputed.csv`, có cột Average Precision và Mục 5.5 về mức đóng góp đặc trưng. Nhóm đã thống nhất chọn bộ slide học thuật 21 trang của Thanh tại `slide/` làm bản chính thức và gỡ bộ 15 slides của Hôn khỏi `reports/` (PR #21). Chương 6 Thảo luận đã hoàn thành, gồm phần quy chiếu Precision về tỷ lệ gian lận gốc của PaySim và phân tích khoảng tin cậy cho thấy khác biệt giữa bốn biến thể học có giám sát chưa đủ tin cậy để xếp hạng. Chương 7 Kết luận và hướng phát triển đã hoàn thành, gồm Bảng 7.1 đối chiếu bảy mục tiêu của Mục 1.3.2. Phase vẫn `pending` chờ Phase 05 xuất comparison CSV cùng ROC/PR figures để đối chiếu, và chờ viết Abstract.
>
