...
| Demo evidence | 🟡 Đã có kịch bản | Browser QA bố cục mới đạt; còn lưu 5 screenshots và quay clip 2–3 phút |
...
| Toàn bộ test hiện có | `85 passed` | Chạy từ repository trên Python 3.14 ngày 09/09/2026 |
...
- [x] Click và pixel QA bố cục Hiệu năng mới trên giao diện Sáng/Tối.
...
1. Chụp screenshots hiện tại và quay demo clip.
...
Phần Phase 06 tự chủ đã hoàn tất UI, XGBoost inference, mẫu test có nhãn, tích hợp đủ comparison/9 figures, lịch sử SQLite và Browser QA bố cục mới. Phase vẫn `pending` do chưa lưu screenshots hiện tại và demo clip.
