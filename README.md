...
| **Sprint 2 (28/8 – 4/9)** | EDA ✅, Preprocessing ✅, Imbalance (SMOTE/ADASYN) ✅, Random Forest ✅, XGBoost & Autoencoder ✅ (Cẩm xong sớm), Báo cáo Word nháp (Chương 1–3) ✅, Slide PPT 15 slides ✅, Streamlit UI Shell Rev 7.7 ✅ | ✅ Vượt tiến độ | Cả nhóm (song song) |
| **Sprint 3 (4/9 – 11/9)** | Báo cáo Chương 4 + Chương 5 ✅ (Duy — DOCX/PDF 24 trang), PM Audit ✅ (Hôn); Evaluation scripts 2/4 ✅ (Khang), **còn thiếu**: confusion_matrix_plot + model_comparator + notebook 06 (Khang); Tích hợp Model UI (Trung — blocked on Phase 05). ⚠️ Sơn cần tạo 2 notebooks (02, 03) | 🔄 Đang triển khai (55.6%) | Khang + Trung + Duy + Sơn + Hôn |
